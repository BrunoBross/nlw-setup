...
CREATE TABLE "new_day_habits" (
    ...
    CONSTRAINT "day_habits_habit_it_fkey" FOREIGN KEY ("habit_it") REFERENCES "habits" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_day_habits" ("day_id", "habit_it", "id") SELECT "day_id", "habit_it", "id" FROM "day_habits";
DROP TABLE "day_habits";
ALTER TABLE "new_day_habits" RENAME TO "day_habits";
CREATE UNIQUE INDEX "day_habits_day_id_habit_it_key" ON "day_habits"("day_id", "habit_it");
